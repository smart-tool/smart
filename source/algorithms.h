...
const struct algo ALGOS[] = {
    ...
    [_TunBM] = {_TunBM, 0, "tunbm", "Tuned Boyer-Moore", 1},
    [_NSN] = {_NSN, 1, "nsn", "not so naive", 0},
    [_TBM] = {_TBM, 1, "tbm", "Turbo Boyer-Moore", 0},
    [_Col] = {_Col, 0, "col", "Colussi", 1},
    [_Smith] = {_Smith, 1, "smith", "Smith", 0},
    [_GG] = {_GG, 0, "gg", "Galil-Giancarlo", 1},
    [_Raita] = {_Raita, 1, "raita", "Raita", 0},
    [_SMOA] = {_SMOA, 1, "smoa", "String Matching on Ordered Alphabets", 0},
    [_RColussi] = {_RColussi, 1, "rcolussi", "Reverse Colussi", 0},
    ...
    [_BLOCK] = {_BLOCK, 0, "block", "2-Block Boyer-Moore", 1},
    ...
    [_DFDM] = {_DFDM, 0, "dfdm", "Double Forward DAWG Matching", 1},
    ...
    [_SBDM] = {_SBDM, 0, "sbdm", "Succint Backward DAWG Matching", 1},
    // Algorithms based on bit-parallelism
    ...
    [_SBNDM2] = {_SBNDM2, 1, "sbndm2", "simplified bndm with loop-unrolling",
                 0},
    [_SBNDM_BMH] = {_SBNDM_BMH, 1, "sbndm-bmh", "sbndm with horspool shift", 0},
    [_BMH_SBNDM] = {_BMH_SBNDM, 1, "bmh-sbndm", "Horspool with SBNDM test", 0},
    ...
    [_BLIM] = {_BLIM, 0, "blim", "bit-parallel length invariant matcher", 0}, // broken
    ...
    // new algorithms
    [_BSDM] = {_BSDM, 1, "bsdm", "Backward SNR DAWG Matching", 0},
    [_BSDM2] = {_BSDM2, 1, "bsdm2", "Backward SNR DAWG Matching (minlength 2)", 0},
    [_BSDM3] = {_BSDM3, 1, "bsdm3", "Backward SNR DAWG Matching (minlength 3)", 0},
    [_BSDM4] = {_BSDM4, 1, "bsdm4", "Backward SNR DAWG Matching (minlength 4)", 0},
    [_BSDM5] = {_BSDM5, 1, "bsdm5", "Backward SNR DAWG Matching (minlength 5)", 0},
    [_BSDM6] = {_BSDM6, 1, "bsdm6", "Backward SNR DAWG Matching (minlength 6)", 0},
    [_BSDM7] = {_BSDM7, 1, "bsdm7", "Backward SNR DAWG Matching (minlength 7)", 0},
    [_BSDM8] = {_BSDM8, 1, "bsdm8", "Backward SNR DAWG Matching (minlength 8)", 0},
    [_BXS] = {_BXS, 1, "bxs", "BXS", 0},
    [_BXS1] = {_BXS1, 1, "bxs1", "BXS with q-grams limit", 0},
    [_BXS2] = {_BXS2, 1, "bxs2", "BXS with q-grams limit", 0},
    [_BXS3] = {_BXS3, 1, "bxs3", "BXS with q-grams limit", 0},
    [_BXS4] = {_BXS4, 1, "bxs4", "BXS with q-grams limit", 0},
    [_BXS6] = {_BXS6, 1, "bxs6", "BXS with q-grams limit", 0},
    [_BXS8] = {_BXS8, 1, "bxs8", "BXS with q-grams limit", 0},
    [_FAOSO2] = {_FAOSO2, 1, "faoso2", "", 0},
    [_FAOSO4] = {_FAOSO4, 1, "faoso4", "", 0},
    [_FAOSO6] = {_FAOSO6, 1, "faoso6", "", 0},
    [_FS_W1] = {_FS_W1, 1, "fs-w1", "", 0},
    [_FS_W2] = {_FS_W2, 1, "fs-w2", "", 0},
    [_FS_W4] = {_FS_W4, 1, "fs-w4", "", 0},
    [_FS_W6] = {_FS_W6, 1, "fs-w6", "", 0},
    [_FS_W8] = {_FS_W8, 1, "fs-w8", "", 0},
    [_FSBNDM_W1] = {_FSBNDM_W1, 1, "fsbndm-w1", "", 0},
    [_FSBNDM_W2] = {_FSBNDM_W2, 1, "fsbndm-w2", "", 0},
    [_FSBNDM_W4] = {_FSBNDM_W4, 1, "fsbndm-w4", "", 0},
    [_FSBNDM_W6] = {_FSBNDM_W6, 1, "fsbndm-w6", "", 0},
    [_FSBNDM_W8] = {_FSBNDM_W8, 1, "fsbndm-w8", "", 0},
    [_FSBNDMQ20] = {_FSBNDMQ20, 1, "fsbndmq20", "", 0},
    [_FSBNDMQ21] = {_FSBNDMQ21, 1, "fsbndmq21", "", 0},
    [_FSBNDMQ31] = {_FSBNDMQ31, 1, "fsbndmq31", "", 0},
    [_FSBNDMQ32] = {_FSBNDMQ32, 1, "fsbndmq32", "", 0},
    [_FSBNDMQ41] = {_FSBNDMQ41, 1, "fsbndmq41", "", 0},
    [_FSBNDMQ42] = {_FSBNDMQ42, 1, "fsbndmq42", "", 0},
    [_FSBNDMQ43] = {_FSBNDMQ43, 1, "fsbndmq43", "", 0},
    [_FSBNDMQ61] = {_FSBNDMQ61, 1, "fsbndmq61", "", 0},
    [_FSBNDMQ62] = {_FSBNDMQ62, 1, "fsbndmq62", "", 0},
    [_FSBNDMQ64] = {_FSBNDMQ64, 1, "fsbndmq64", "", 0},
    [_FSBNDMQ81] = {_FSBNDMQ81, 1, "fsbndmq81", "", 0},
    [_FSBNDMQ82] = {_FSBNDMQ82, 1, "fsbndmq82", "", 0},
    [_FSBNDMQ84] = {_FSBNDMQ84, 1, "fsbndmq84", "", 0},
    [_FSBNDMQ86] = {_FSBNDMQ86, 1, "fsbndmq86", "", 0},
    [_IOM] = {_IOM, 1, "iom", "", 0},
    [_JOM] = {_JOM, 1, "jom", "", 0},
    [_LWFR2] = {_LWFR2, 1, "lwfr2", "", 0},
    [_LWFR3] = {_LWFR3, 1, "lwfr3", "", 0},
    [_LWFR4] = {_LWFR4, 1, "lwfr4", "", 0},
    [_LWFR5] = {_LWFR5, 1, "lwfr5", "", 0},
    [_LWFR6] = {_LWFR6, 1, "lwfr6", "", 0},
    [_LWFR7] = {_LWFR7, 1, "lwfr7", "", 0},
    [_LWFR8] = {_LWFR8, 1, "lwfr8", "", 0},
    [_QF23] = {_QF23, 1, "qf23", "", 0},
    [_QF24] = {_QF24, 1, "qf24", "", 0},
    [_QF26] = {_QF26, 1, "qf26", "", 0},
    [_QF28] = {_QF28, 1, "qf28", "", 0},
    [_QF33] = {_QF33, 1, "qf33", "", 0},
    [_QF34] = {_QF34, 1, "qf34", "", 0},
    [_QF36] = {_QF36, 1, "qf36", "", 0},
    [_QF42] = {_QF42, 1, "qf42", "", 0},
    [_QF43] = {_QF43, 1, "qf43", "", 0},
    [_QF44] = {_QF44, 1, "qf44", "", 0},
    [_QF62] = {_QF62, 1, "qf62", "", 0},
    [_QF63] = {_QF63, 1, "qf63", "", 0},
    [_QLQS] = {_QLQS, 1, "qlqs", "", 0},
    [_SBNDM_W2] = {_SBNDM_W2, 1, "sbndm-w2", "", 0},
    [_SBNDM_W4] = {_SBNDM_W4, 1, "sbndm-w4", "", 0},
    [_SBNDM_W6] = {_SBNDM_W6, 1, "sbndm-w6", "", 0},
    [_SKIP2] = {_SKIP2, 1, "skip2", "", 0},
    [_SKIP3] = {_SKIP3, 1, "skip3", "", 0},
    [_SKIP4] = {_SKIP4, 1, "skip4", "", 0},
    [_SKIP5] = {_SKIP5, 1, "skip5", "", 0},
    [_SKIP6] = {_SKIP6, 1, "skip6", "", 0},
    [_SKIP7] = {_SKIP7, 1, "skip7", "", 0},
    [_SKIP8] = {_SKIP8, 1, "skip8", "", 0},
    [_SSM] = {_SSM, 1, "ssm", "", 0},
    [_TSA] = {_TSA, 1, "tsa", "", 0},
    [_TSA_Q2] = {_TSA_Q2, 1, "tsa-q2", "", 0},
    [_TSO5] = {_TSO5, 1, "tso5", "", 0},
    [_TUNEDBM] = {_TUNEDBM, 1, "tunedbm", "", 0},
    [_TVSBS_W2] = {_TVSBS_W2, 1, "tvsbs-w2", "", 0},
    [_TVSBS_W4] = {_TVSBS_W4, 1, "tvsbs-w4", "", 0},
    [_TVSBS_W6] = {_TVSBS_W6, 1, "tvsbs-w6", "", 0},
    [_TVSBS_W8] = {_TVSBS_W8, 1, "tvsbs-w8", "", 0},
    [_TWFR2] = {_TWFR2, 1, "twfr2", "", 0},
    [_TWFR3] = {_TWFR3, 1, "twfr3", "", 0},
    [_TWFR4] = {_TWFR4, 1, "twfr4", "", 0},
    [_TWFR5] = {_TWFR5, 1, "twfr5", "", 0},
    [_TWFR6] = {_TWFR6, 1, "twfr6", "", 0},
    [_TWFR7] = {_TWFR7, 1, "twfr7", "", 0},
    [_TWFR8] = {_TWFR8, 1, "twfr8", "", 0},
    [_TWFRQ2] = {_TWFRQ2, 1, "twfrq2", "", 0},
    [_TWFRQ3] = {_TWFRQ3, 1, "twfrq3", "", 0},
    [_TWFRQ4] = {_TWFRQ4, 1, "twfrq4", "", 0},
    [_TWFRQ5] = {_TWFRQ5, 1, "twfrq5", "", 0},
    [_TWFRQ6] = {_TWFRQ6, 1, "twfrq6", "", 0},
    [_TWFRQ7] = {_TWFRQ7, 1, "twfrq7", "", 0},
    [_TWFRQ8] = {_TWFRQ8, 1, "twfrq8", "", 0},
    [_TWFR] = {_TWFR, 1, "twfr", "", 0},
    [_WC] = {_WC, 1, "wc", "", 0},
    [_WFR2] = {_WFR2, 1, "wfr2", "", 0},
    [_WFR3] = {_WFR3, 1, "wfr3", "", 0},
    [_WFR4] = {_WFR4, 1, "wfr4", "", 0},
    [_WFR5] = {_WFR5, 1, "wfr5", "", 0},
    [_WFR6] = {_WFR6, 1, "wfr6", "", 0},
    [_WFR7] = {_WFR7, 1, "wfr7", "", 0},
    [_WFR8] = {_WFR8, 1, "wfr8", "", 0},
    [_WFRQ2] = {_WFRQ2, 1, "wfrq2", "", 0},
    [_WFRQ3] = {_WFRQ3, 1, "wfrq3", "", 0},
    [_WFRQ4] = {_WFRQ4, 1, "wfrq4", "", 0},
    [_WFRQ5] = {_WFRQ5, 1, "wfrq5", "", 0},
    [_WFRQ6] = {_WFRQ6, 1, "wfrq6", "", 0},
    [_WFRQ7] = {_WFRQ7, 1, "wfrq7", "", 0},
    [_WFRQ8] = {_WFRQ8, 1, "wfrq8", "", 0},
    [_WFR] = {_WFR, 1, "wfr", "", 0},
    [_WOM] = {_WOM, 1, "wom", "", 0},
    // state of the art:
    [_SSECP] = {_SSECP, 0, "ssecp", "SSE Crochemore-Perrin", 0}, // broken
