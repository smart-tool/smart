...
const struct algo ALGOS[] = {
    ...
    [_Skip] = {_Skip, 1, "skip", "Skip Serach", 0, 0},
    ...
    [_AKC] = {_AKC, 1, "akc", "AKC algorithm", 0, 0},
    ...
    [_SKIP2] = {_SKIP2, 1, "skip2", "", 2, 0},
    [_SKIP3] = {_SKIP3, 1, "skip3", "", 3, 0},
    [_SKIP4] = {_SKIP4, 1, "skip4", "", 4, 0},
    [_SKIP5] = {_SKIP5, 1, "skip5", "", 5, 0},
    [_SKIP6] = {_SKIP6, 1, "skip6", "", 6, 0},
    [_SKIP7] = {_SKIP7, 1, "skip7", "", 7, 0},
    [_SKIP8] = {_SKIP8, 1, "skip8", "", 8, 0},
    // Algorithms based on bit-parallelism
    ...
    [_BSDM2] = {_BSDM2, 1, "bsdm2", "Backward SNR DAWG Matching (minlength 2)", 2, 0},
    [_BSDM3] = {_BSDM3, 1, "bsdm3", "Backward SNR DAWG Matching (minlength 3)", 3, 0},
    [_BSDM4] = {_BSDM4, 1, "bsdm4", "Backward SNR DAWG Matching (minlength 4)", 4, 0},
    [_BSDM5] = {_BSDM5, 1, "bsdm5", "Backward SNR DAWG Matching (minlength 5)", 5, 0},
    [_BSDM6] = {_BSDM6, 1, "bsdm6", "Backward SNR DAWG Matching (minlength 6)", 6, 0},
    [_BSDM7] = {_BSDM7, 1, "bsdm7", "Backward SNR DAWG Matching (minlength 7)", 7, 0},
    [_BSDM8] = {_BSDM8, 1, "bsdm8", "Backward SNR DAWG Matching (minlength 8)", 8, 0},
    ...
    [_QF23] = {_QF23, 1, "qf23", "Q-gram Filtering q=2 s=3", 2, 0},
    [_QF24] = {_QF24, 1, "qf24", "Q-gram Filtering q=2 s=4", 2, 0},
    [_QF26] = {_QF26, 1, "qf26", "Q-gram Filtering q=2 s=6", 2, 0},
    [_QF28] = {_QF28, 1, "qf28", "Q-gram Filtering q=2 s=8", 2, 0},
    [_QF33] = {_QF33, 1, "qf33", "Q-gram Filtering q=3 s=3", 3, 0},
    [_QF34] = {_QF34, 1, "qf34", "Q-gram Filtering q=3 s=4", 3, 0},
    [_QF36] = {_QF36, 1, "qf36", "Q-gram Filtering q=3 s=6", 3, 0},
    [_QF42] = {_QF42, 1, "qf42", "Q-gram Filtering q=4 s=2", 4, 0},
    [_QF43] = {_QF43, 1, "qf43", "Q-gram Filtering q=4 s=3", 4, 0},
    [_QF44] = {_QF44, 1, "qf44", "Q-gram Filtering q=4 s=4", 4, 0},
    [_QF62] = {_QF62, 1, "qf62", "Q-gram Filtering q=6 s=2", 6, 0},
    [_QF63] = {_QF63, 1, "qf63", "Q-gram Filtering q=6 s=3", 6, 0},
    ...
    [_TWFR5] = {_TWFR5, 1, "twfr5", "", 0, 0},
    [_TWFR6] = {_TWFR6, 1, "twfr6", "", 0, 0},
    [_TWFR7] = {_TWFR7, 1, "twfr7", "", 0, 0},
    [_TWFR8] = {_TWFR8, 1, "twfr8", "", 0, 0},
    [_TWFRQ2] = {_TWFRQ2, 1, "twfrq2", "", 0, 0},
    [_TWFRQ3] = {_TWFRQ3, 1, "twfrq3", "", 0, 0},
    [_TWFRQ4] = {_TWFRQ4, 1, "twfrq4", "", 0, 0},
    [_TWFRQ5] = {_TWFRQ5, 1, "twfrq5", "", 0, 0},
    [_TWFRQ6] = {_TWFRQ6, 1, "twfrq6", "", 0, 0},
    [_TWFRQ7] = {_TWFRQ7, 1, "twfrq7", "", 0, 0},
    [_TWFRQ8] = {_TWFRQ8, 1, "twfrq8", "", 0, 0},
    [_TWFR] = {_TWFR, 1, "twfr", "", 0, 0},
    [_WC] = {_WC, 1, "wc", "", 0, 0},
    [_WFR2] = {_WFR2, 1, "wfr2", "", 0, 0},
    [_WFR3] = {_WFR3, 1, "wfr3", "", 0, 0},
    [_WFR4] = {_WFR4, 1, "wfr4", "", 0, 0},
    [_WFR5] = {_WFR5, 1, "wfr5", "", 0, 0},
    [_WFR6] = {_WFR6, 1, "wfr6", "", 0, 0},
    [_WFR7] = {_WFR7, 1, "wfr7", "", 0, 0},
    [_WFR8] = {_WFR8, 1, "wfr8", "", 0, 0},
    [_WFRQ2] = {_WFRQ2, 1, "wfrq2", "", 0, 0},
    [_WFRQ3] = {_WFRQ3, 1, "wfrq3", "", 0, 0},
    [_WFRQ4] = {_WFRQ4, 1, "wfrq4", "", 0, 0},
    [_WFRQ5] = {_WFRQ5, 1, "wfrq5", "", 0, 0},
    [_WFRQ6] = {_WFRQ6, 1, "wfrq6", "", 0, 0},
    [_WFRQ7] = {_WFRQ7, 1, "wfrq7", "", 0, 0},
    [_WFRQ8] = {_WFRQ8, 1, "wfrq8", "", 0, 0},
    [_WFR] = {_WFR, 1, "wfr", "", 0, 0},
    [_WOM] = {_WOM, 1, "wom", "", 0, 0},
    // state of the art:
