...
/*
 * Simplified Backward Nondeterministic DAWG Matching with Horspool shift
 * designed for large patterns The present implementation searches for prefixes
 * of the pattern of length 32. When an occurrence is found the algorithm tests
 * for the whole occurrence of the pattern
 */
