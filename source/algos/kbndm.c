 ...
 * A Compact Representation of Nondeterministic (Suffix) Automata for the
 * Bit-Parallel Approach. Combinatorial Pattern Matching, Lecture Notes in
 * Computer Science, vol.6129, pp.288--298, Springer-Verlag, Berlin, (2010).
 */
