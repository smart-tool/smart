 ...
 * in R. Thathoo and A. Virmani and S. S. Lakshmi and N. Balakrishnan and K.
 * Sekar. TVSBS: A Fast Exact Pattern Matching Algorithm for Biological
 * Sequences. J. Indian Acad. Sci., Current Sci., vol.91, n.1, pp.47--53,
 * (2006).
 */
