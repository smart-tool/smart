 ...
 *
 * This is an implementation of the Forward Nondeterministic DAWG Matching
 * algorithm in J. Holub and B. Durian. Talk: Fast variants of bit parallel
 * approach to suffix automata. The Second Haifa Annual International
 * Stringology Research Workshop of the Israeli Science Foundation, (2005).
 */
