 ...
 *
 * This is an implementation of the Bit Parallel Wide Window^2 algorithm
 * in D. Cantone and S. Faro and E. Giaquinta.
 * Bit-Parallelism^2: Getting to the Next Level of Parallelism.
 * Fun with Algorithms, Lecture Notes in Computer Science, vol.6099,
 * pp.166--177, Springer-Verlag, Berlin, (2010).
 */
