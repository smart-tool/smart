 ...
 *
 * This is an implementation of the Two-Way Nondeterministic DAWG Matching
 * algorithm in H. Peltola and J. Tarhio. Alternative Algorithms for
 * Bit-Parallel String Matching. Proceedings of the 10th International Symposium
 * on String Processing and Information Retrieval SPIRE'03, (2003).
 */
